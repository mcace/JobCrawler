...
public class JsoupDemo {
    public static void main(String[] args) {
        String html = "<!DOCTYPE html>\n" +
                ...
                ".css><title>百度一下，你就知道</title></head> <body link=#0000cc> <div id=wrapper> <div " +
                ...
                "autocomplete=off autofocus=autofocus></span><span class=\"bg s_btn_wr\"><input " +
                "type=submit id=su value=百度一下 class=\"bg s_btn\" autofocus></span> </form> </div> " +
                "</div> <div id=u1> <a href=http://news.baidu.com name=tj_trnews class=mnav>新闻</a> " +
                ...
                ".baidu.com%2f%3fbdorz_come%3d1 name=tj_login class=lb>登录</a> </noscript> " +
                "<script>document.write('<a href=\"http://www.baidu.com/bdorz/login" +
                ".gif?login&tpl=mn&u='+ encodeURIComponent(window.location.href+ (window.location" +
                ".search === \"\" ? \"?\" : \"&\")+ \"bdorz_come=1\")+ '\" name=\"tj_login\" " +
                "class=\"lb\">登录</a>');\n" +
                "                </script> " +
                "<a href=//www.baidu.com/more/ name=tj_briicon class=bri style=\"display: block;\">更多产品</a>" +
                " </div> </div> </div> <div id=ftCon> <div id=ftConw> <p id=lh>" +
                ...
                "京ICP证030173号&nbsp; <img src=//www.baidu.com/img/gs.gif> </p> </div> </div> " +
                "</div> </body> </html>\n<!DOCTYPE html>\n" +
                "<!--STATUS OK--><html> <head><meta http-equiv=content-type content=text/html;" +
                "charset=utf-8><meta http-equiv=X-UA-Compatible content=IE=Edge><meta " +
                "content=always name=referrer><link rel=stylesheet type=text/css " +
                ...
                "<a href=http://www.baidu.com/duty/>使用百度前必读</a>&nbsp; " +
                "<a href=http://jianyi.baidu.com/ class=cp-feedback>意见反馈</a>&nbsp;" +
                "京ICP证030173号&nbsp; <img src=//www.baidu.com/img/gs.gif> </p> </div> </div> </div>" +
                " </body> </html>\n";

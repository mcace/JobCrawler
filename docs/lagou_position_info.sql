...
CREATE TABLE `lagou_position_info` (
  ...
  `companyFullName` varchar(20) NOT NULL DEFAULT '',
  ...
  `imState` varchar(10) NOT NULL DEFAULT '',
  `longitude` varchar(20) NOT NULL DEFAULT '',
  `latitude` varchar(20) NOT NULL DEFAULT '',
  `linestaion` varchar(300) NOT NULL DEFAULT '',
  `lastLogin` bigint(20) unsigned NOT NULL DEFAULT '0',
  `pcShow` int(1) unsigned NOT NULL DEFAULT '0',
  `positionName` varchar(20) NOT NULL DEFAULT '',
  `positionLables` varchar(30) NOT NULL DEFAULT '',
